...
class StateMachine:
    ...
    def handle_user_field_b_response_state(self):
        if self.person_detected_in_field('B') and not self.person_detected_in_field('A') and not ferrometaldetected:
            ...
            self.door_controller.open_mri_room_door()
            self.led_controller.set_color("FerrometalDetector", "green")
...
class LEDController:
    ...
    def __init__(self):
        self.leds = {
            ...
            "fieldB": WS2812(pin_number=3, num_leds=2, brightness=50),
            "FerrometalDetector": WS2812(pin_number=6, num_leds=2, brightness=50)
        }
...
class SensorController:
    ...
    def __init__(self):
        self.sensors = {
            ...
            "fieldB": LD2410PersonDetector(uart_number=1, baudrate=256000, tx_pin=4, rx_pin=5)
        }
